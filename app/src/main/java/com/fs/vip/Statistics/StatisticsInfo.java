...
import static com.fs.vip.Statistics.AppInformation.bootTime;
...
//        }
    ...
    public ArrayList<AppInformation> getEnableList() {
        ArrayList<AppInformation> temp = new ArrayList<>();
        for (int i = 0;i<ShowList.size();i++){
            if (TextUtils.isEmpty(SharedPreferencesUtil.getInstance().getString(ShowList.get(i).getPackageName()))){
